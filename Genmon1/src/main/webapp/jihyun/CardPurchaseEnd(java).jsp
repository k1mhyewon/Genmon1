...
<!-- 보더 -->
 <div style="width: 700px; color: #4e4e4e;margin: 0 auto; color: #cccccc; padding: 0;"> 
	 <div style="position: relative; margin: 0; padding:0;"> 
		 <h1 style="padding: 10px 0; margin: 0px;"><img src="image/Gentle_monster_logo.png" style="width: 300px; height: 30px;" alt="" loading="lazy"></h1> 
		...
		<tbody>
			<tr>
				<td style="text-align:left;width:60%"> 
					<h2 style="margin: 0;padding: 0;font-family:NanumBarunGothic, nbg, dotum, sans-serif;float:left;font-size: 55px;color: #000">Purchase</h2>
				</td>
				<td> 
...
<table style="width:100%; border-top-color: rgb(183, 183,183); border-top-width: 1px; border-top-style:solid; table-layout:fixed; border-collapse:collapse; "> 
	...
	<tbody>
		<tr><th colspan="1" rowspan="1" style="font-size:12px; font-family: Myriad SetPro,Lucida Grande,HelveticaNeue,Helvetica,Arial,Verdana,sans-serif;font-weight: normal; border-bottom-color: rgb(222,222, 222); border-bottom-width: 1px;border-bottom-style: solid; color:#333;background:#f4f4f4; text-align:left;padding-top:7px; padding-left:10px;padding-bottom:5px;">Name</th><td style="font-size:13px; font-family: Myriad SetPro,Lucida Grande,HelveticaNeue,Helvetica,Arial,Verdana,sans-serif;border-bottom: 1px solid #dedede;padding-left:5px;"><b><%-- 이름 --%></b></td></tr> 
		<tr><th colspan="1" rowspan="1" style="font-size:12px; font-family:Myriad Set Pro,Lucida Grande,HelveticaNeue,Helvetica,Arial,Verdana,sans-serif;font-weight: normal; border-bottom-color: rgb(222,222, 222); border-bottom-width: 1px;border-bottom-style: solid; color:#333;background:#f4f4f4; text-align:left;padding-top:7px; padding-left:10px;padding-bottom:5px;">Address</th><td style="font-size:12px; font-family: Myriad SetPro,Lucida Grande,HelveticaNeue,Helvetica,Arial,Verdana,sans-serif;border-bottom: 1px solid #dedede;padding-left:5px;">	<%-- 주소 --%></td></tr>
		<tr><th colspan="1" rowspan="1" style="font-size:12px; font-family:Myriad Set Pro,Lucida Grande,HelveticaNeue,Helvetica,Arial,Verdana,sans-serif;font-weight: normal; border-bottom-color: rgb(222,222, 222); border-bottom-width: 1px;border-bottom-style: solid; color:#333;background:#f4f4f4; text-align:left;padding-top:7px; padding-left:10px;padding-bottom:5px;">Tel</th><td style="font-size:12px; font-family: Myriad SetPro,Lucida Grande,HelveticaNeue,Helvetica,Arial,Verdana,sans-serif;border-bottom: 1px solid #dedede;padding-left:5px;"><%-- 연락처 --%></td></tr>
	</tbody>
</table> 
...
<table style="width:100%; border-top-color:rgb(183, 183, 183); border-top-width: 1px;border-top-style: solid; table-layout:fixed;border-collapse: collapse; "> 
	...
	<tbody>
		<tr><th colspan="1" rowspan="1" style="font-size:12px;font-family: Myriad Set Pro,LucidaGrande,HelveticaNeue,Helvetica,Arial,Verdana,sans-serif;font-weight: normal; border-bottom-color: rgb(222,222, 222); border-bottom-width: 1px;border-bottom-style: solid; color:#333;background:#f4f4f4; text-align:left;padding-top:7px;padding-left:10px;padding-bottom:5px;">Purchase No</th>
			<td style="font-size:12px; font-family:Myriad Set Pro,Lucida Grande,HelveticaNeue,Helvetica,Arial,Verdana,sans-serif;border-bottom: 1px solid #dedede;padding-left:5px;" colspan="3"><%-- 구매번호 --%></td></tr> 
		
		<tr><th colspan="1" rowspan="1" style="font-size:12px;font-family: Myriad Set Pro,LucidaGrande,HelveticaNeue,Helvetica,Arial,Verdana,sans-serif;font-weight: normal; border-bottom-color: rgb(222,222, 222); border-bottom-width: 1px;border-bottom-style: solid; color:#333;background:#f4f4f4; text-align:left;padding-top:7px;padding-left:10px;padding-bottom:5px;">Date</th>
			<td style="font-size:12px; font-family: Myriad SetPro,Lucida Grande,HelveticaNeue,Helvetica,Arial,Verdana,sans-serif;border-bottom: 1px solid #dedede;padding-left:5px; color:#f4412d" colspan="3"><%-- 구매일 --%></td>
		</tr> 
		<tr><th colspan="1" rowspan="1" style="font-size:12px; font-family: Myriad SetPro,Lucida Grande,HelveticaNeue,Helvetica,Arial,Verdana,sans-serif;font-weight: normal; border-bottom-color: rgb(222,222, 222); border-bottom-width: 1px;border-bottom-style: solid; color:#333;background:#f4f4f4; text-align:left;padding-top:7px;padding-left:10px;padding-bottom:5px;">Address</th>
			<td style="font-size:12px; font-family: Myriad SetPro,Lucida Grande,HelveticaNeue,Helvetica,Arial,Verdana,sans-serif;border-bottom: 1px solid #dedede;padding-left:5px;" colspan="3"><%-- 주소 --%></td></tr>
	</tbody>
</table> 

<!-- end -->

 <!-- footer --> <div style="font-family: 나눔고딕,NanumG_N;border-top: 2px solid #333; padding: 9px0px 0px 0px; margin: 32px 0px 0px 0px;"> <table style="border: 0px currentColor; border-image:none;padding-top:10px"> <tbody><tr><td style="width:500px;padding-left:20px"> <em style="font-style: normal; font-size: 13px; font-weight:bold; letter-spacing: -1px; padding: 7px 0 0;color: #333; display: block;">본 메일은
