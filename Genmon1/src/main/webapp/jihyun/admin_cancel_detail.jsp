...
<body>
	<div style="width: 80%; margin: 0 auto;">
		<span class="boldtxt my-4">주문취소상세</span>
		...
		<ul>
			<li><span class="list_span">총금액 </span> 235,000원</li>
			<li><span class="list_span">적립금 사용 </span> 1,000원</li>
			<li style="text-decoration: underline;"><span class="list_span">환불금액 </span> 234,000원</li>
