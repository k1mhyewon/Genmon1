...
<link rel="stylesheet" type="text/css" href="adminProductDel.css">
<style type="text/css">
</style>
...
<script type="text/javascript">
		 ...
		 $("btn-Edit()").click(function () {
			function form() {
				if(document.getElementById("prod-name").value==''){
					alert("상품명을 입력해주십시오.");
					return false;
				}
				if(document.getElementById("prod-desc").value==''){
					alert("상품설명을 입력해주십시오.");
					return false;
				}
	...
	<form id="frm" action ="#" >
		<fieldset>
			...
			<div class="form-floating">
			  <textarea class="form-control" placeholder="Leave a comment here" id="prod-name"></textarea>
			  <label for="floatingTextarea">상품명</label>
			 </div>
			 <br>
			 <div class="form-floating">
			  <textarea class="form-control" placeholder="Leave a comment here" id="prod-desc" style="height: 100px"></textarea>
			  <label for="floatingTextarea2">상품설명</label>
			 </div> 
			 <br>
			 <select id="form-select" name="select"  aria-label="Default select example">
			  <option selected>카테고리 선택</option>
			  <option value="1">전체보기</option>
			  <option value="2">베스트상품</option>
			  <option value="3">선글라스</option>
			</select>
			<br>
			<div class="input-group mb-3">
			  <input type="file" id="form-file" name="file" value="업로드" accept="image/*">
			  <label class="form-file-text" for="inputGroupFile"></label>
			</div>
     	...
     	<div class="item-info-box">
     		...
     		<div class="item-info-cotent-box">
	      		<div class="item-info-cotent">
					<div class="item-stock"><a href="#" class="stock-link" style="border-bottom: thin;">재고 105개</a></div>	      		
	 		...
	 		<div class="add-option-btn">
		 			<div class="cart-btn" >
		 				<button type="button" class="btn btn-dark btn-block" id="prodEdit" onclick="btn-Edit()" style="background-color: #000000;">수정</button>
		 			</div>
		 			<br>
		 			<div class="del-btn" >
		 				<button type="button" class="btn btn-dark btn-block"  id="proDel" onclick="btn-Del()" style="background-color: #000000;">삭제</button>
		 			</div>
	 		</div>
 	    	<br>
	 	   ...
	 	   <%-- 리뷰 관리 --%>
	 	   <div class="review"><a href="#"  class="admin-review" id="adminReview">상품리뷰(15개)</a>
	 	   </div>
       	   <br>
