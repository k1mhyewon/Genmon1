		...
		<%-- 제품 정보 --%>
     	<div class="item-info-box">
	 		...
	 		<div class="add-option-btn">
		 			<div class="cart-btn" >
		 				<button type="button" class="btn btn-dark btn-block" id="add-cart-btn" onclick="addtoEdit()" style="background-color: #000000;">수정</button>
		 			</div>
		 			<br>
		 			<div class="del-btn" >
		 				<button type="button" class="btn btn-dark btn-block"  id="del-cart-btn" onclick="addtoDel()" style="background-color: #000000;">삭제</button>
		 			</div>
	 		</div>
 	    	<br>
